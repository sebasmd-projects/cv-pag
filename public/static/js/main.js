...
(function () {
  ...
  function togglewhatsappB() {
    if (whatsappB) {
      window.scrollY > 100
        ? whatsappB.classList.add("active")
        : whatsappB.classList.remove("active");
    }
  }
  ...
  function sendMessage() {
    ...
    let whatsappURL = `https://api.whatsapp.com/send?phone=${phone}&text=${encodeURIComponent(
      messageField
    )}`;
  ...
  document
    .querySelector("#send-whatsapp-message")
